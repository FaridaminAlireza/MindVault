...
of the parabola. It is used to instantly identify
the maximum or minimum point of a graph and 
to easily graph functions through transformations,
where h is the horizontal shift and k is the vertical
shift. 
...
Step 3: Rewrite z in vertex form 
