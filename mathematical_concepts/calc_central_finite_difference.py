...
---
SECTION 1: 
The second finite difference (Δ² f_i) is
a discrete analogue of the second derivative.

Definition: Delta squared f_i is defined as
...
The error is O(h^2), meaning that
the error shrinks proportionally
...
This symmetry causes cancellation of 
odd error terms and improves accuracy.
...
SECTION 6: First Derivative representation (Δ f_i)  
...
discrete versions of derivatives.
